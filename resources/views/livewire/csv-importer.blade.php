                            ...
                            <div class="flex flex-1 flex-col justify-between">
                                <div class="p-4 sm:p-6">
                                    <div>
                                        <!-- File drop -->
                                        <div
                                            class="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-dashed
                                            rounded-md"
                                            x-bind:class="{
                                            ...
                                            <div class="space-y-1 text-center">
                                                ...
                                                <div class="flex text-sm text-gray-600">
                                                    <label for="file"
                                                        ...
                                                        <input id="file" wire:model="file" name="file" type="file"
                                                               class="sr-only">
                                                    </label>
                                    ...
                                    @error('file')<span
                                        class="mt-2 text-red-500 font-medium text-sm">{{ $message }}</span> @enderror
                                    <!-- End file drop -->
                                        ...
                                        <div class="mt-4 space-y-5">
                                            ...
                                            <div class="grid grid-cols-4 gap-4 items-start">
                                                ...
                                                <div class="mt-1 sm:mt-0 sm:col-span-3">
                                                    <select wire:model.defer="columnsToMap.{{ $column }}" type="text" name="{{ $column }}" id="{{ $column }}"
                                                    ...
                                                    @error('columnsToMap.' . $column)<span
                                                        class="mt-2 text-red-500 font-medium text-sm">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
